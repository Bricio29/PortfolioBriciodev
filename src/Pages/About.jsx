        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              Tenho 22 anos, sou estudante de Sistemas de Informação, apaixonado
              por desenvolvimento de software e design de sites. Meu objetivo é
              criar soluções digitais inovadoras e eficientes, sempre com foco
              na experiência do usuário e na entrega de resultados de qualidade.
            </p>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a
                href="https://drive.google.com/file/d/1dIIu0crrQXCurCkNw5h-0GuiXTWZy9__/view?usp=sharing"
